...
def testData(net1, criterion, CUDA_DEVICE, testloader10, testloader, noiseMagnitude1, temper):
    t0 = time.time()
    root = os.path.dirname(__file__)
    f1 = open(os.path.join(root, "softmax_scores/confidence_Base_In.txt"), 'w')
    f2 = open(os.path.join(root, "softmax_scores/confidence_Base_Out.txt"), 'w')
    g1 = open(os.path.join(root,"softmax_scores/confidence_Our_In.txt"), 'w')
    g2 = open("./ood/odin/softmax_scores/confidence_Our_Out.txt", 'w')
    N = 10000
